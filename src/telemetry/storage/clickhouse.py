...
ORDER BY (sensor_type, device_id, timestamp);
...
class ClickHouseStorage(StorageBackend):
    ...
    async def write_window_stats(self, stats: list[WindowStats]) -> None:
        ...
        rows = [
            [
                s.device_id, s.sensor_type, _fmt_ts(s.window_start), _fmt_ts(s.window_end),
        ...
        await self._insert(
            ...
            rows,
            columns=[
                "device_id", "sensor_type", "window_start", "window_end",
    ...
    async def write_anomaly(self, score: AnomalyScore) -> None:
        ...
        await self._insert(
            ...
            [[
                score.device_id, score.sensor_type, _fmt_ts(score.timestamp),
            ...
            columns=[
                "device_id", "sensor_type", "timestamp", "score", "is_anomaly",
